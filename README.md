> **当前状态：返工中，实景验收未通过。** V2.2.1 仅为历史可运行原型，不能视为这两处修正完成。当前复核登记 48 张候选图、21 个细节项；验收与缺口见 [SOP 复核报告](verification/sop_reaudit/README.md)。正式打包已受 `ACTIVE_REVIEW.json` 门禁约束。
