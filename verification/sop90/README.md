...
- 最近一次运行平均 111.3 FPS；仅代表本机本次检查画面，不能代表整图最低帧率。
...
有效近期目标外景仍为 6 张，尚未满足至少10张及完整机位覆盖。新增2025年5月和2026年6月摄影原帖保留逐图拍摄日期；其他近照和街景包括2022、2024年初、2019年5月资料，只用于发现结构差异，不能冒充近期照片。
