...
updates={
 'G03':('新增南侧 L 接点的抬高屋顶体块、檐口及圆拱小窗；与前部坡屋顶的高差、位置仍待多机位校准。','SOP90_Gallery_raised_roof_block'),
...
for item in a['items']:
 ...
 extra={'G03':['baidu_gallery_201905'],'G05':['gallery_yx2022_detail','gallery_night_trip_2024'],'G08':['gallery_yx2022_detail','gallery_night_trip_2024'],'M08':['market_xinhua_202501'],'S01':['baidu_gallery_201905']}.get(item['id'],[])
...
有效近期目标外景仍为 {len(result['eligible_recent_photos'])} 张，未满10张/3来源。新增近照和街景包括2022、2024年初、2019年5月资料，只用于发现结构差异，不能冒充近期照片。
...
for title,photo,render in [('砖廊','references/v2_2/brick_gallery_2025.jpg','renders/sop_rework/DAY_gallery.png'),('道里菜市场','references/sop_reaudit/local/market_primary_20250621.jpg','renders/sop_rework/DAY_market.png')]:
